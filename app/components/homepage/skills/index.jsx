...
function Skills () {
  return (
    <div id='skills' className='relative z-50 border-t lg:my-24 my-12 border-[#25213b]'>
        <Image
        src='/section.svg'
        alt='Hero'
        width={1572}
        ...
        >
        {
            skillsData.map((skill,id)=>(
                <div key={id} className='w-36 min-w-fit h-fit flex flex-col items-center justify-center transition-all duration-500 m-3 sm:m-5 rounded-lg group relative cursor-pointer'>
                    <div className='h-full w-full rounded-lg border border-[#1f223c] 
                    bg-[#11152c] shadow-gray-50 group-hover:border-violet-500 transition-all duration-500'>
