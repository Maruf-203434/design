        ...
        <div className=' grid grid-cols-1 items-start lg:grid-cols-2 lg:gap-12 gap-y-8'>
          <div className=' order-2 lg:order-1 flex flex-col items-start justify-center p-2 pb-20 md:pb-10 lg:pt-10'>
            ...
            <div className='flex items-center gap-3'>
             ...
             <button className='px-3 text-xs md:px-8 py-3 md:py-4 bg-[#0d1224] rounded-full border-none text-center md:text-sm font-medium uppercase tracking-wider text-[#fff] no-underline transition-all duration-200 ease-out md:font-semibold flex items-center gap-1
              hover:gap-3'>
